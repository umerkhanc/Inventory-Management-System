...
if __name__ == "__main__":
    ...
    items = [['Set Wet Hair Gel Cool, 50ml', 10, 'Rs 50.5', 'Rs 505.0'], ['Set Wet Hair Gel Cool, 50ml', 20, 'Rs 50.5', 'Rs 1010.0'], ['Fair & Lovely Women, 50g', 50, 'Rs 97.0', 'Rs 4850.0'], ['Nivea Lip Balm, 4.8g', 140, 'Rs 105.0', 
        'Rs 14700.0'], ['testing', 1, 'Rs 1.0', 'Rs 10.0'], ['testing', 1, 'Rs 10.0', 'Rs 10.0']]
